...
DROP DATABASE IF EXISTS josephwatkin_pr;
CREATE DATABASE josephwatkin_pr CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
GRANT ALL ON josephwatkin_pr.* TO 'jwadmin'@'localhost';
GRANT ALL ON josephwatkin_pr.* TO 'jwadmin'@'%';
DROP DATABASE IF EXISTS josephwatkin_dev;
CREATE DATABASE josephwatkin_dev CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
DROP DATABASE IF EXISTS josephwatkin_qa;
CREATE DATABASE josephwatkin_qa CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
